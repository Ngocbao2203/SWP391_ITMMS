...
const IvfAppointmentForm = ({ service, onRegistrationSuccess, onSubmitting }) => {
  ...
  const loadAvailableTimeSlots = useCallback(async () => {
    ...
    try {
      ...
      const timeSlots = await doctorService.getAvailableTimeSlots(
        selectedDoctor, 
        dateStr,
  ...
  const handleDateChange = (date) => {
    ...
    form.setFieldsValue({ timeSlot: undefined }); // Reset time slot when date changes
    setAvailableTimeSlots([]);
  };
            ...
            <Col xs={24}>
              ...
              <div className="ivf-form-section">
                <div className="ivf-form-step-header">
                  ...
                  <h3 className="ivf-form-step-title">Chọn bác sĩ</h3>
                </div>
                    ...
                    {doctors.map(doctor => (
                      ...
                      >
                        <div className="ivf-doctor-avatar">
                          <img 
                            src={doctor.profileImage || 'https://via.placeholder.com/80x80'} 
                            alt={doctor.name} 
                          />
                        </div>
